...
The group implies *Inventory / User*, so assigned users can access the
Locations report without any further configuration. Stock managers
always keep the editable manager layout regardless of this group.
